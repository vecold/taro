...
function filterProps(properties) {
  ...
  for (var propName in properties) {
    ...
    } else if (propName in weappComponentData && (properties[propName].value !== null || weappComponentData[propName] !== null)) {
...
function doUpdate(component, prevProps, prevState) {
  ...
  component.$scope.setData(dataDiff, function () {
    ...
    var cbs = component._pendingCallbacks;
